---
description: Guide an app across bundle versions using ml1 update and migration notes
---

# /minlang:bundle-upgrade-coach

Guide an app across bundle versions using ml1 update and migration notes
...
3. Execute the command-specific work described in the design doc for **bundle-upgrade-coach**.
...
Primary verification: `ml1 update --check`

---
description: Convert existing unit/e2e expectations into MinLang tests
---

# /minlang:migrate-tests

Convert existing unit/e2e expectations into MinLang tests
...
3. Execute the command-specific work described in the design doc for **migrate-tests**.

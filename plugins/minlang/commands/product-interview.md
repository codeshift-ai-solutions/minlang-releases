---
description: Ask only the product questions needed to produce a valid MinLang app
---

# /minlang:product-interview

Ask only the product questions needed to produce a valid MinLang app
...
3. Execute the command-specific work described in the design doc for **product-interview**.

---
description: Go from one paragraph idea to compiled app, tests, and dev server
---

# /minlang:demo-from-idea

Go from one paragraph idea to compiled app, tests, and dev server
...
3. Execute the command-specific work described in the design doc for **demo-from-idea**.
...
Primary verification: `ml1 validate <file> && make compile && make test && make dev`

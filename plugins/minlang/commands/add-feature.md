---
description: Make one product change by editing only MinLang source
---

# /minlang:add-feature

Make one product change by editing only MinLang source
...
3. Execute the command-specific work described in the design doc for **add-feature**.

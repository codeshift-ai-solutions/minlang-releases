---
description: Map a desired feature to current language support gaps
---

# /minlang:why-not-supported

Map a desired feature to current language support gaps
...
3. Execute the command-specific work described in the design doc for **why-not-supported**.
...
Primary verification: `ml1 features`

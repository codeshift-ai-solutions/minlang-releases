---
description: Scan for logic that belongs in .ml but leaked into generated or shell code
---

# /minlang:boundary-police

Scan for logic that belongs in .ml but leaked into generated or shell code
...
3. Execute the command-specific work described in the design doc for **boundary-police**.
...
Primary verification: `make compile`

---
description: Verify app compatibility with latest compiler, bundle, runtime, and generated output
---

# /minlang:release-check

Verify app compatibility with latest compiler, bundle, runtime, and generated output
...
3. Execute the command-specific work described in the design doc for **release-check**.
...
Primary verification: `ml1 update --check && make compile && make test`

---
description: Run the Creator/Gatekeeper preflight plus ml1 validate
---

# /minlang:validate-authority

Run the Creator/Gatekeeper preflight plus ml1 validate
...
3. Execute the command-specific work described in the design doc for **validate-authority**.

---
description: Extract entities, constraints, actions, and queries from one feature area
---

# /minlang:migrate-domain

Extract entities, constraints, actions, and queries from one feature area
...
3. Execute the command-specific work described in the design doc for **migrate-domain**.

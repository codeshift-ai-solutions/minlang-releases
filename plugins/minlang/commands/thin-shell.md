---
description: Identify shell code that violates presentation-only boundaries
---

# /minlang:thin-shell

Identify shell code that violates presentation-only boundaries
...
3. Execute the command-specific work described in the design doc for **thin-shell**.

---
description: Explain project graph and compile closure
---

# /minlang:inspect-graph

Explain project graph and compile closure
...
3. Execute the command-specific work described in the design doc for **inspect-graph**.
...
Primary verification: `ml1 graph <file>`

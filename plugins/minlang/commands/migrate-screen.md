---
description: Turn an existing UI route or component into MinLang screen blocks
---

# /minlang:migrate-screen

Turn an existing UI route or component into MinLang screen blocks
...
3. Execute the command-specific work described in the design doc for **migrate-screen**.

---
description: Translate ml1 validate and compile errors into concrete fixes
---

# /minlang:explain-failure

Translate ml1 validate and compile errors into concrete fixes
...
3. Execute the command-specific work described in the design doc for **explain-failure**.

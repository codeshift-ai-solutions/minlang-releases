---
description: Detect duplicated validation, copy, and business rules across app code
---

# /minlang:dedupe-rules

Detect duplicated validation, copy, and business rules across app code
...
3. Execute the command-specific work described in the design doc for **dedupe-rules**.

---
description: Audit an existing app and create a phased migration map into MinLang
---

# /minlang:migrate-project

Audit an existing app and create a phased migration map into MinLang
...
3. Execute the command-specific work described in the design doc for **migrate-project**.
